...
export default function InventoryLevels() {
  ...
  return (
    <div className="bg-black p-6 rounded-2xl shadow-md w-full text-white">
    
      <div className="flex items-start justify-between mb-4">
        <div>
          <h2 className=" font-bold">Inventory Movement Trends</h2>
          <p className="text-gray-400 text-sm">
            Tract inventoty inflows and outflows over time
          </p>
        </div>
